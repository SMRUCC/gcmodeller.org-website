...
<head>
    ...
    <meta property="og:url" content="https://orchid.software/en/docs" />
    <meta property="og:locale" content="en" />
    <meta property="og:title" content="Documentation | Orchid - Laravel Admin Panel" />
    ...
    <meta name="twitter:url" content="https://orchid.software/en/docs">
    <meta name="twitter:title" content="Documentation | Orchid - Laravel Admin Panel">
    <meta name="twitter:description"
        content="Learn about Laravel Orchid, the open-source package for accelerating the development of administration-style applications. Explore the documentation for features like permission management, notifications, attachments, form builder, charts, configuration, controllers, custom templates, display elements, form elements, Eloquent filters, global search with Scout, layers for grouping, and using icons and SVG icons in your project.">
    <meta name="twitter:image" content="https://github.com/orchidsoftware/art/raw/master/orchid-share.jpg">

    <meta http-equiv="Content-Security-Policy"
        content="frame-ancestors metrika.yandex.ru metrika.yandex.by metrica.yandex.com metrica.yandex.com.tr webvisor.com *.webvisor.com;">
    <meta name="view-transition" content="same-origin">

    <link rel="alternate" href="https://orchid.software/ru/docs/" hreflang="ru" />
    <link rel="alternate" href="https://orchid.software/en/docs/" hreflang="en" />
    <link rel="alternate" href="https://orchid.software/en/docs/" hreflang="x-default" />
        ...
        <div class="container pt-md-4 pt-2 position-relative">
            <header class="d-flex flex-wrap align-items-center justify-content-center py-3 mb-4 px-4 position-relative">
                ...
                <ul class="nav nav-pills ms-auto">
                    <li class="nav-item"><a href="https://orchid.software/en/docs"
                    ...
                    <main class="py-2 px-3 py-md-2 px-md-4 px-xl-5 ms-lg-4 me-lg-auto order-md-first overflow-auto">
                        ...
                        <div class="anchors">
                            <ul>
                                ...
                                <li class="anchor-h2">
                                    <a href="#what-sets-orchid-apart-from-other-packages">What Sets Orchid Apart from
                                        Other Packages?</a>
                                </li>
                                <li class="anchor-h2">
                        ...
                        <body>
                            ...
                            <ul>
                                <li>A form builder that eliminates the need to manually describe HTML fields of the same
                                    type.</li>
                                ...
                                <li>Permissions management that makes it easy to manage user access in development and
                                    support.</li>
                                <li>Additional features such as menus, charts, notifications, and more.</li>
                            </ul>
                            <p>As a Laravel package, Orchid seamlessly integrates with other components and can serve as
                                the foundation for applications such as content management systems.</p>
                            <blockquote>
                                <p>This documentation is intended for users familiar with the Laravel. If you are new to
                            ...
                            <h2><a href='#looking-for-something-simpler' id='looking-for-something-simpler'>Looking for
                                    Something Simpler?</a></h2>
                            <p>If you&rsquo;re searching for a more straightforward solution for creating simple
                                applications with minimal coding, Laravel Orchid&rsquo;s <strong>CRUD</strong> feature
                                ...
                                creation of basic applications. To get started, take a look at the <a
                                    href="https://orchid.software/en/docs/packages/crud/#introduction">CRUD section</a>
                                of the documentation.</p>
                            <h2><a href='#migrating-to-orchid' id='migrating-to-orchid'>Migrating to Orchid</a></h2>
                            <p>If you currently have an admin panel based on <code>Blade</code> templates, you do not
                                ...
                                gradually transition to using Orchid by <a
                                    href="https://orchid.software/en/docs/controllers">connecting old controllers</a>
                                and integrating Orchid&rsquo;s features into your existing application. This way, you
                            ...
                            <p>It&rsquo;s crucial to understand that Orchid is a powerful tool for developers but not a
                                &ldquo;turnkey&rdquo; solution. This means that it&rsquo;s not suitable for individuals
                            ...
                            <p>Furthermore, it&rsquo;s important to recognize that not all developers may be open to
                                using a new tool, and forcing it could lead to resistance or even sabotage. If you face
                                resistance from your development team, it&rsquo;s essential to have an open and honest
                                conversation to address their concerns as best as possible. Seeking advice from an
                                experienced professional could also be helpful in finding a mutually agreeable solution
                                that works for everyone involved.</p>
                            <h2><a href='#what-sets-orchid-apart-from-other-packages'
                                    id='what-sets-orchid-apart-from-other-packages'>What Sets Orchid Apart from Other
                                    Packages?</a></h2>
                            <p>The Laravel ecosystem offers a variety of admin panels, such as Nova, Voyager, BackPack,
                                and QuickAdminPanel, that aim to simplify the process of working with CRUD applications.
                                However, Laravel Orchid stands out by offering a different approach to streamlining the
                                development process.</p>
                            <p>Unlike other packages that rely on scaffolding or visual programming, Laravel Orchid is
                                designed to be helpful at any stage of development and can grow with your application as
                                it becomes more complex. Instead of generating physical stubs files or dragging and
                                dropping objects, Orchid requires developers to write code using a keyboard. And instead
                                of providing a single god class, it offers a range of small, reusable components that
                                can be combined in various ways to build a wide range of applications.</p>
                            <p>Orchid&rsquo;s approach is designed to be flexible, allowing developers to adapt it to
                                their specific needs and workflows. It can be used for simple CRUD applications, but it
                            ...
                            <ul>
                                <li>
                                    <p><strong>Presentation level</strong> &ndash; a graphical interface presented to
                                        the user (browser), including scripts, styles, and other resources.</p>
                                </li>
                                <li>
                                    <p><strong>The level of applied logic</strong> &ndash; in our cases, this framework
                                        is the link where most business logic is concentrated, works with the database
                                        (Eloquent), sending resources, and various processing.</p>
                                </li>
                                <li>
                                    <p><strong>Level of resource management</strong> &ndash; data storage&nbsp;using
                                        database management systems (MySQL, PostgreSQL, Microsoft SQL Server, SQLite).
                                    </p>
                                </li>
                            </ul>
                            <p>
                            ...
                            <p>It reduces development time, which is directly related to the distribution of
                                responsibilities between levels. This is especially noticeable when it&rsquo;s necessary
                            ...
                            <ul>
                                <li>Generation of &ldquo;HTML&rdquo; using the &ldquo;Blade&rdquo; template engine or
                                    the &ldquo;Vue&rdquo; framework.</li>
                                <li>Use of ORM or stored procedures.</li>
                            </ul>
                            <p>Depending on the choice of decisions, responsibilities are assigned, each decision having
...
└── View         |
    ...
    └── <span class="hl-constant">JS</span>       |
                            ...
                            <p>If you find that something is missing or unclear in our documentation, we welcome
                                contributions to improve it. You can click on the <strong>Suggest Edits</strong> link on
